   var XMLHttpReq;  
        ...
        function Refresh() {
        	...
        	for(var i=0;i<j;i++)
           {
            ...
            var RefreshLastGathDateSize = XMLHttpReq.responseXML.getElementsByTagName("RefreshLastGathDateSize"+i)[0].firstChild.nodeValue;              
            document.getElementById("RefreshLastGathDateSize"+i).innerHTML = RefreshLastGathDateSize;
           }
        } 